...
class KMSAWSManagedKeysSearcher(AwsResourceSearcher):
    id = "kms-awsmanagedkeys"
    ...
    def list_res(self, limit=SettingValues.search_limit):
        ...
        kms_key_list = filter(
            lambda k: k.alias.startswith("alias/aws/"),
            kms_key_list,
        )
...
kms_awsmanagedkeys_searcher = KMSAWSManagedKeysSearcher()
